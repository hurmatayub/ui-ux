...
const CarSummary = () => {
  return (
    <>
      <div className="w-full md:w-[492px] h-auto md:h-[580px] absolute top-[160px] left-0 md:left-[916px] rounded-[10px] bg-white p-6">
        <div className="w-full md:w-[444px] h-auto space-y-4">
          <p className="text-[18px] md:text-[20px] font-bold leading-[30px] text-[#1A202C]">
            Rental Summary
          </p>
          <p className="text-[12px] md:text-[14px] font-medium leading-[21px] text-[#90A3BF]">
            Prices may change depending on the length of the rental and the price of your rental car.
          </p>
        </div>

        <div className="flex flex-col md:flex-row items-start mt-[24px]">
          <div className="relative w-[132px] h-[108px] mx-auto md:ml-7 mt-4 rounded-[8px]">
            <Image
              src="/images/Look.png"
              alt="Car"
              width={188}
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="text-[24px] md:text-[32px] mt-5 font-bold leading-[48px] text-[#1A202C]">
              Nissan GT - R
            </p>
            <div className="flex justify-center md:justify-start items-center gap-2">
              ...
              <p className="text-[12px] md:text-[14px] font-medium text-[#596780]">440+ Reviews</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between">
            <p className="text-[14px] md:text-[16px] font-medium text-[#90A3BF]">Subtotal</p>
            <p className="text-[14px] md:text-[16px] font-semibold text-[#1A202C]">$80.00</p>
          </div>
          <div className="flex justify-between">
            <p className="text-[14px] md:text-[16px] font-medium text-[#90A3BF]">Tax</p>
            <p className="text-[14px] md:text-[16px] font-semibold text-[#1A202C]">$0.00</p>
          </div>
        </div>

        <div className="w-full h-[56px] rounded-[10px] bg-[#F6F7F9] mt-[16px] flex justify-between items-center px-4">
          <p className="text-[12px] md:text-[14px] font-medium text-[#90A3BF]">Apply promo code</p>
          <p className="text-[14px] md:text-[16px] font-semibold text-[#1A202C]">Apply now</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between mt-[24px]">
          ...
          <p className="text-[24px] md:text-[32px] font-bold leading-[40px] text-[#1A202C] text-center md:text-right">$80.00</p>
        </div>
      </div>
    </>
  );
