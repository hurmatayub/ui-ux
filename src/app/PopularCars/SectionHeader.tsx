  ...
  return (
    <div className="flex gap-[1076px] items-start text-base font-semibold text-center max-md:max-w-full">
      <div className="w-[132px] h-[44px] px-[20px]  gap-[8px] ">
        <div className="w-[180px] h-[24px] flex items-center justify-center">
          <p className="font-['Plus Jakarta Sans'] text-[16px] font-semibold leading-[20.16px] text-center text-[#90A3BF] whitespace-nowrap">
            {title}
          </p>
        </div>
      </div>
